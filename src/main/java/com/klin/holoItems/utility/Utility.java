...
public class Utility {
    ...
    public static final Set<Material> logs = Set.of(ACACIA_LOG, OAK_LOG, BIRCH_LOG, DARK_OAK_LOG, JUNGLE_LOG, SPRUCE_LOG, CRIMSON_STEM, WARPED_STEM, STRIPPED_ACACIA_LOG, STRIPPED_OAK_LOG, STRIPPED_BIRCH_LOG, STRIPPED_DARK_OAK_LOG, STRIPPED_JUNGLE_LOG, STRIPPED_SPRUCE_LOG, STRIPPED_CRIMSON_STEM, STRIPPED_WARPED_STEM, ACACIA_WOOD, OAK_WOOD, BIRCH_WOOD, DARK_OAK_WOOD, JUNGLE_WOOD, SPRUCE_WOOD, CRIMSON_HYPHAE, WARPED_HYPHAE, STRIPPED_ACACIA_WOOD, STRIPPED_OAK_WOOD, STRIPPED_BIRCH_WOOD, STRIPPED_DARK_OAK_WOOD, STRIPPED_JUNGLE_WOOD, STRIPPED_SPRUCE_WOOD, STRIPPED_CRIMSON_HYPHAE, STRIPPED_WARPED_HYPHAE, OAK_LEAVES, SPRUCE_LEAVES, BIRCH_LEAVES, JUNGLE_LEAVES, ACACIA_LEAVES, DARK_OAK_LEAVES, NETHER_WART_BLOCK, WARPED_WART_BLOCK, MUSHROOM_STEM, BROWN_MUSHROOM_BLOCK, RED_MUSHROOM_BLOCK);
