package com.klin.holoItems.collections.hidden.opCollection;

import com.klin.holoItems.Collection;
import com.klin.holoItems.collections.hidden.opCollection.items.*;
...
public class OpCollection extends Collection {
    ...
    public OpCollection(){
        ...
        collection.add(new CarnivalUnlimitedKrisWorks());
    }
